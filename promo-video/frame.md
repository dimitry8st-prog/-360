...
colors:
  ...
  text-muted: "#2e9d68"
  text-light: "#9A9A9A"
  accent-light: "rgba(245, 130, 32, 0.08)"
  accent-medium: "rgba(245, 130, 32, 0.15)"
  border: "rgba(245, 130, 32, 0.2)"
  card-bg: "rgba(245, 130, 32, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Inter** (display) / **Manrope** (body); ignore any preset font name lingering in prose.
